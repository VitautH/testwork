...
private $error;  // true|false
    public function Validation()
    {
        ...
        if (!empty ($_POST['email']) and !empty($_POST['name']) and !empty ($_POST['message']) and !isset($_POST['g-recaptcha-response'])) { // Проверка на заполненность обязательных полей формы
...
Сообщение успешно добавлено!.
    ...
    private function Valid_Captcha()
    {
            ...
            try {
                ...
                return false; // Ошибка. Выбрасываем исключение
            }
